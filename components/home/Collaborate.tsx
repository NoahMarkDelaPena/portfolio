  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col justify-center items-center gap-12 z-10">
        <h1 className="text-4xl font-extrabold tracking-tight lg:text-7xl z-10 text-white text-center">
          Want to collaborate?
        </h1>
        <div className="flex flex-col justify-center items-center gap-3 mt-8 text-center">
          <h3 className="text-lg lg:text-2xl font-semibold tracking-tight text-white">
            Send me a message through email or any of these social links.
          </h3>
          <div className="flex flex-col lg:flex-row justify-center items-center gap-6">
            <button
              className="bg-white text-gray-700 hover:bg-gray-200 cursor-pointer inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium h-10 px-4 py-2"
